...
public: \
	DECLARE_CLASS(UEditorPythonScriptingLibrary, UBlueprintFunctionLibrary, COMPILED_IN_FLAGS(0), CASTCLASS_None, TEXT("/Script/PythonScriptPlugin"), NO_API) \
...
private: \
	...
	UEditorPythonScriptingLibrary(const UEditorPythonScriptingLibrary&); \
public: \
...
template<> PYTHONSCRIPTPLUGIN_API UClass* StaticClass<class UEditorPythonScriptingLibrary>();
