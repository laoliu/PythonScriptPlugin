...
ue_PyFProperty *ue_get_python_fproperty(FProperty *);
ue_PyFProperty *ue_get_python_fproperty_inc(FProperty *);
...
ue_PyFFieldClass *ue_get_python_ffieldclass(FFieldClass *);
ue_PyFFieldClass *ue_get_python_ffieldclass_inc(FFieldClass *);
