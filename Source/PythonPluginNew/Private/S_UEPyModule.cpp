...
#include "S_UEPyEngine.h"
#include "S_UEPyTimer.h"
#include "S_UEPyTicker.h"
#include "S_UEPyVisualLogger.h"

#include "UObject/S_UEPyObject.h"
#if ENGINE_MAJOR_VERSION == 5 || (ENGINE_MAJOR_VERSION == 4 && ENGINE_MINOR_VERSION >= 25)
#include "UObject/S_UEPyProperty.h"
#endif
#include "UObject/S_UEPyActor.h"
#include "UObject/S_UEPyTransform.h"
#include "UObject/S_UEPyPlayer.h"
#include "UObject/S_UEPyInput.h"
#include "UObject/S_UEPyWorld.h"
#include "UObject/S_UEPyNavigation.h"
#include "UObject/S_UEPySpline.h"
#include "UObject/S_UEPyMovements.h"
#include "UObject/S_UEPyAttaching.h"
#include "UObject/S_UEPySkeletal.h"
#include "UObject/S_UEPyStaticMesh.h"
#include "UObject/S_UEPyTraceAndSweep.h"
#include "UObject/S_UEPyPhysics.h"
#include "UObject/S_UEPyAudio.h"
#include "UObject/S_UEPySequencer.h"
#include "UObject/S_UEPyViewport.h"
#include "UObject/S_UEPyWidget.h"
#include "UObject/S_UEPyWidgetComponent.h"
#include "UObject/S_UEPyPackage.h"
#include "UObject/S_UEPyTexture.h"
#include "UObject/S_UEPyMaterial.h"
#include "UObject/S_UEPyPawn.h"
#include "UObject/S_UEPyController.h"
#include "UObject/S_UEPyHUD.h"
#include "UObject/S_UEPyAnimSequence.h"
#include "UObject/S_UEPyCapture.h"
#include "UObject/S_UEPyLandscape.h"
#include "UObject/S_UEPyUserDefinedStruct.h"
#include "UObject/S_UEPyDataTable.h"
#include "UObject/S_UEPyExporter.h"
#include "UObject/S_UEPyFoliage.h"
...
#include "S_UEPyAssetUserData.h"
#if WITH_EDITOR
#include "S_UEPyEditor.h"
#include "Blueprint/S_UEPyEdGraph.h"
#include "Fbx/S_UEPyFbx.h"
#include "Editor/BlueprintGraph/Classes/EdGraphSchema_K2.h"
#include "Editor/BlueprintGraph/Public/BlueprintActionDatabase.h"
#endif

#include "Wrappers/S_UEPyESlateEnums.h"

#include "Wrappers/S_UEPyFVector.h"
#include "Wrappers/S_UEPyFVector2D.h"
#include "Wrappers/S_UEPyFHitResult.h"
#include "Wrappers/S_UEPyFRotator.h"
#include "Wrappers/S_UEPyFTransform.h"
#include "Wrappers/S_UEPyFColor.h"
#include "Wrappers/S_UEPyFLinearColor.h"
#include "Wrappers/S_UEPyFSocket.h"
#include "Wrappers/S_UEPyFQuat.h"

#include "Wrappers/S_UEPyFRawAnimSequenceTrack.h"

#include "Wrappers/S_UEPyFRandomStream.h"

#include "Wrappers/S_UEPyFPythonOutputDevice.h"
#if WITH_EDITOR
#include "Wrappers/S_UEPyFSoftSkinVertex.h"
#endif
#include "Wrappers/S_UEPyFMorphTargetDelta.h"
#include "Wrappers/S_UEPyFObjectThumbnail.h"

#include "Wrappers/S_UEPyFViewportClient.h"
#if WITH_EDITOR
#include "Wrappers/S_UEPyFEditorViewportClient.h"
#include "Wrappers/S_UEPyIAssetEditorInstance.h"
#endif

#include "Wrappers/S_UEPyFFoliageInstance.h"

#include "S_UEPyCallable.h"
#include "S_UEPyUClassesImporter.h"
#include "S_UEPyEnumsImporter.h"
#include "S_UEPyUStructsImporter.h"

#if ENGINE_MAJOR_VERSION == 5 || (ENGINE_MAJOR_VERSION == 4 && ENGINE_MINOR_VERSION >= 25)
#include "S_UEPyFPropertiesImporter.h"
#endif

#include "S_UEPyUScriptStruct.h"

#if WITH_EDITOR
#include "Wrappers/S_UEPyFSlowTask.h"
#include "Wrappers/S_UEPyFAssetData.h"
#include "Wrappers/S_UEPyFARFilter.h"
#include "Wrappers/S_UEPyFRawMesh.h"
#include "Wrappers/S_UEPyFStringAssetReference.h"

#include "UObject/S_UEPyAnimSequence.h"
#include "Blueprint/S_UEPyEdGraphPin.h"
#include "S_UEPyIPlugin.h"
#include "CollectionManager/S_UEPyICollectionManager.h"
#include "MaterialEditorUtilities/S_UEPyFMaterialEditorUtilities.h"
#endif

#include "Wrappers/S_UEPyFFrameNumber.h"

#include "Slate/S_UEPySlate.h"
#include "Http/S_UEPyIHttp.h"
#include "ConsoleManager/S_UEPyIConsoleManager.h"
#include "SlateApplication/S_UEPyFSlateApplication.h"
#include "Voice/S_UEPyIVoiceCapture.h"

#include "S_PythonFunction.h"
...
static PyObject* py_unreal_engine_exec(PyObject* self, PyObject* args)
{
	...
	PythonModule.RunFile(args1, args2, PythonCommand);
...
void unreal_engine_init_py_module()
{
	...
	PyObject* new_unreal_engine_module = PyImport_GetModule(module_name);
