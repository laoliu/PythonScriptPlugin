...
#include "S_PyWrapperObject.generated.h"
...
UCLASS(Transient)
class UPythonGeneratedClass_S final : public UClass, public IPythonResourceOwner_S
{
	GENERATED_BODY()
...
public:
	...
	static UPythonGeneratedClass_S* GenerateClass(PyTypeObject* InPyType);
	...
	static bool ReparentDerivedClasses(UPythonGeneratedClass_S* InOldParent, UPythonGeneratedClass_S* InNewParent);

	/** Generate an Unreal class based on the given class, but using the given parent class (also update the Python type) */
	static UPythonGeneratedClass_S* ReparentClass(UPythonGeneratedClass_S* InOldClass, UPythonGeneratedClass_S* InNewParent);
