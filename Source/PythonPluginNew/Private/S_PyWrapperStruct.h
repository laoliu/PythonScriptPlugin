...
#include "S_PyWrapperStruct.generated.h"
...
UCLASS()
class UPythonGeneratedStruct_S final : public UScriptStruct, public IPythonResourceOwner_S
{
	GENERATED_BODY()
...
public:
	...
	static UPythonGeneratedStruct_S* GenerateStruct(PyTypeObject* InPyType);
