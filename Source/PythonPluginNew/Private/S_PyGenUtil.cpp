...
static ETypeHintingMode_S GTypeHintingMode = ETypeHintingMode_S::Off; // Use through SetTypeHintingMode()/IsTypeHintingEnabled()
...
void SetTypeHintingMode(ETypeHintingMode_S InMode)
{
	GTypeHintingMode = InMode;
}

ETypeHintingMode_S GetTypeHintingMode()
{
	if (!IsTypeHintingEnabled()) // Can be disable if the Python version is too old.
	{
		return ETypeHintingMode_S::Off;
	}
...
bool IsTypeHintingEnabled()
{
	...
	return GTypeHintingMode != ETypeHintingMode_S::Off;
#else
	return false;
#endif
}
