...
#include UE_INLINE_GENERATED_CPP_BY_NAME(S_PyWrapperDelegate)

const FName UPythonCallableForDelegate_S::GeneratedFuncName = "CallPython";

DEFINE_FUNCTION(UPythonCallableForDelegate_S::CallPythonNative)
{
#if WITH_PYTHON
...
#if WITH_PYTHON
void UPythonCallableForDelegate_S::BeginDestroy()
{
	ReleasePythonResources();
	Super::BeginDestroy();
}

void UPythonCallableForDelegate_S::ReleasePythonResources()
{
...
PyObject* UPythonCallableForDelegate_S::GetCallable() const
{
	return (PyObject*)PyCallable.GetPtr();
}

void UPythonCallableForDelegate_S::SetCallable(PyObject* InCallable)
{
	FPyScopedGIL GIL;
...
bool PythonCallableToDelegate(PyObject* InPyCallable, const PyGenUtil::FGeneratedWrappedFunction& InDelegateSignature, const UClass* InPythonCallableForDelegateClass, FScriptDelegate& OutDelegate, const TCHAR* InErrorCtxt)
{
	...
	UPythonCallableForDelegate_S* PythonCallableForDelegate = NewObject<UPythonCallableForDelegate_S>(GetTransientPackage(), (UClass*)InPythonCallableForDelegateClass);
	PythonCallableForDelegate->SetCallable(InPyCallable);
	OutDelegate.BindUFunction(PythonCallableForDelegate, UPythonCallableForDelegate_S::GeneratedFuncName);
	return true;
}
...
PyTypeObject InitializePyWrapperMulticastDelegateType()
{
	...
	struct FMethods
	{
		...
		static PyObject* AddCallableUnique(FPyWrapperMulticastDelegate* InSelf, PyObject* InArgs)
		{
			...
			{
				if (const UPythonCallableForDelegate_S* PythonCallableForDelegate = ::Cast<UPythonCallableForDelegate_S>(DelegateObj))
				{
		...
		static PyObject* RemoveCallable(FPyWrapperMulticastDelegate* InSelf, PyObject* InArgs)
		{
			...
			UPythonCallableForDelegate_S* PythonCallableForDelegateToRemove = nullptr;
