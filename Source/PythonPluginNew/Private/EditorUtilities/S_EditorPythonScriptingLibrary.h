...
#include "S_EditorPythonScriptingLibrary.generated.h"


/**
 * Utility class for Python scripting functionality.
 */
UCLASS(meta=(ScriptName="EditorPythonScripting_S"))
class UEditorPythonScriptingLibrary_S : public UBlueprintFunctionLibrary
{
	GENERATED_BODY()
