...
#include "S_PyWrapperEnum.generated.h"
...
UCLASS()
class UPythonGeneratedEnum_S final : public UEnum, public IPythonResourceOwner_S
{
	GENERATED_BODY()
...
public:
	...
	static UPythonGeneratedEnum_S* GenerateEnum(PyTypeObject* InPyType);
