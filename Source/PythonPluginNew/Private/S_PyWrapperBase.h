...
#include "S_PyWrapperBase.generated.h"
...
class UPythonResourceOwner_S : public UInterface
{
	GENERATED_UINTERFACE_BODY()
};

class IPythonResourceOwner_S
{
...
class UPythonObjectHandle_S final : public UObject, public IPythonResourceOwner_S
{
	GENERATED_BODY()
...
public:
	 ...
	 */
	static UPythonObjectHandle_S* Create(PyObject* PyObjPtr);
