...
def test_py_core_methods() -> None:
    ...
    # cursory warnings for the next section that uses a non-existent blueprint located at /Game/AAAA/ActorBP - comment out the following supressions and example warnings if you have an asset saved as such
    unreal.AutomationLibrary.add_expected_log_error("Failed to load '/Game/AAAA/ActorBP': Can't find file.", 0, False)
    unreal.log_warning("[FAKE] Failed to load '/Game/AAAA/ActorBP': Can't find file.")
    unreal.AutomationLibrary.add_expected_log_error("Failed to find object 'Object /Game/AAAA/ActorBP.ActorBP'", 0, False)
    unreal.log_warning("[FAKE] Failed to find object 'Object /Game/AAAA/ActorBP.ActorBP'")
    ...
    unreal.AutomationLibrary.add_expected_log_error("Failed to find string table entry for '/Game/AAAA/StrTable' 'Foo'. Did you forget to add a string table redirector?", 0, False)
    unreal.log_warning("[FAKE] Failed to find string table entry for '/Game/AAAA/StrTable' 'Foo'. Did you forget to add a string table redirector?")
